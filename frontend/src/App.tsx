 ...
 *
 * These credentials are for the current local development stage.
 *
 * Production authentication will be implemented properly later.
 * WebAuthn / Passkey authentication will be added in Step 5.
 */
    ...
    <div className="login-screen">
      ...
      <div className="login-card">
        ...
        <div className="login-header">
          ...
          <p>
            Authenticate to access the VERITAS digital
            media forensic environment.
          </p>
        </div>
        ...
        >
          <div className="login-field">
            <label htmlFor="veritas-username">
              ANALYST USERNAME
            </label>
          ...
          <div className="login-field">
            <label htmlFor="veritas-password">
              PASSWORD
            </label>
  ...
  <span>Login with Passkey</span>
        ...
        <div className="login-security">
          ...
          <div>
            ...
            <span>
              Authentication session is maintained
...
void loadHistory();
  ...
  function formatPercent(
    ...
    return `${formatSafeNumber(number, 2)}%`;
  }
    ...
    <div className="page-section">
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <p>
            VERITAS provides an evidence-oriented
            workspace for analyzing digital media,
        ...
        <div className="hero-visual">
          ...
          <div className="hero-core">
            <div className="hero-core-letter">
              V
            </div>
      ...
      <section className="dashboard-card recent-analysis-card">
        ...
        {recentAnalyses.length === 0 ? (
          <div className="empty-state">
            ...
            <p>
              Completed media analyses will appear
              here after you run an investigation.
            </p>
        ...
        <div className="dashboard-module-overview">
          ...
          <div className="dashboard-module-status">
            ...
            <div>
              ...
              <span>
                Current and planned forensic modules
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="dashboard-card integrity-card">
        ...
        <div className="integrity-copy">
          ...
          <h2>
            Analysis-first forensic workflow
          </h2>

          <p>
            VERITAS records analysis metadata and
            separates implemented forensic signals
            from planned capabilities. No unavailable
            forensic measurement is presented as an
            actual result.
          </p>
        </div>
...
function InvestigationPage({
  ...
  const realProbability =
    result?.model?.real_probability ??
    result?.real_probability;

  const fakeProbability =
    result?.model?.fake_probability ??
        ...
        <div className="pipeline-large">
          <div className="pipeline-step">
            ...
            <div className="pipeline-content">
              ...
              <span>
                File validation and media decoding
              </span>
            </div>
          </div>
          ...
          <div className="pipeline-step">
            ...
            <div className="pipeline-content">
              ...
              <span>
                Inspect embedded image properties and
                EXIF data
              </span>
            </div>
          </div>
          ...
          <div className="pipeline-step">
            ...
            <div className="pipeline-content">
              ...
              <span>
                Locate facial regions for analysis
              </span>
            </div>
          </div>
          ...
          <div className="pipeline-step">
            ...
            <div className="pipeline-content">
              ...
              <span>
                Evaluate facial imagery with the trained
                model
              </span>
            </div>
          </div>
          ...
          <div className="pipeline-step">
            ...
            <div className="pipeline-content">
              ...
              <span>
                Consolidate available analytical findings
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="investigation-layout">
        <section className="intake-panel">
          ...
          >
            {!selectedFile ? (
              <>
                <div className="drop-zone-symbol">
                  ↑
                </div>
                ...
                <p>
                  Drag and drop an image into this
                  area, or select a file manually.
                </p>
          ...
          <div className="intake-notice">
            ...
            <p>
              Current engine supports image-based
              facial analysis. JPEG, PNG, and WebP
              files are accepted.
            </p>
          </div>
        </section>
      ...
      {isAnalyzing && (
        <section className="processing-panel">
          ...
          <div>
            ...
            <p>
              Decoding image, extracting metadata,
              detecting facial regions, and executing
              classification.
            </p>
          </div>
            ...
            <section className="dashboard-card case-record-card">
              ...
              <div className="metadata-forensics-grid">
                ...
                <div className="metadata-forensics-item">
                  ...
                  <strong
                    title={
                      result.image_integrity?.sha256 || undefined
                    }
                  >
                    {result.image_integrity?.sha256
                      ? result.image_integrity.sha256
                      : "Unavailable"}
                  </strong>
                </div>
              ...
              <div className="intake-notice">
                <span>ⓘ</span>
                <p>
                  The case ID is linked to the persisted analysis record.
                  The SHA-256 value is the evidence hash returned by the
                  integrity module. Forensic indicators are supporting
                  evidence and should be interpreted together with the
            ...
            {result.error ? (
              ...
              <>
                <div className="verdict-layout">
                  <div
                    className={`verdict-panel ${verdictClass}`}
                  >
                ...
                <section className="dashboard-card gradcam-card">
                  <div className="panel-header">
                    <div>
                      ...
                      <p className="panel-description">
                        Visual explanation highlighting the facial regions
                        that influenced the EfficientNet-B0 classification.
                      </p>
                    </div>
                  ...
                  {result?.explainability?.heatmap_base64 ? (
                    <div className="gradcam-content">
                      ...
                      <div className="gradcam-details">
                        ...
                        <div className="gradcam-detail-block">
                          ...
                          <p>
                            Heatmap generated for the predicted class
                            using the selected face region.
                          </p>
                        </div>
                        ...
                        <div className="gradcam-note">
                          <span>ⓘ</span>
                          <p>
                            Grad-CAM is an interpretability aid. It shows
                            where the model focused; it is not independent
                    ...
                    <div className="gradcam-empty">
                      <div className="gradcam-empty-icon">
                        ✦
                      </div>
                ...
                <section className="dashboard-card metadata-forensics-card">
                  <div className="panel-header">
                    <div>
                      ...
                      <p className="panel-description">
                        Inspect embedded image properties
                        and metadata returned by the
                        forensic engine.
                      </p>
                    </div>
                  ...
                  {!metadata ? (
                    <div className="metadata-unavailable">
                      <div className="metadata-unavailable-icon">
                        !
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          The forensic engine did not
                          return metadata information for
                          this analysis.
                        </p>
                      </div>
                    </div>
                    ...
                    <>
                      ...
                      <div className="metadata-forensics-note">
                        ...
                        <p>
                          ...
                          is an investigative observation,
                          not by itself proof that an image
                          is authentic or manipulated.
                          Metadata can be removed, modified,
                          or regenerated by image processing
                          software.
                        </p>
                      </div>
                    </>
                ...
                <section className="dashboard-card forensic-analysis-results-card noise-frequency-dashboard">
                  <div className="panel-header">
                    <div>
                      <div className="card-eyebrow">
                        FORENSIC MODULE 08
                      ...
                      <p className="panel-description">
                        Visual analysis of image noise, sharpness and frequency-domain characteristics generated from the submitted evidence.
                      </p>
                    </div>
                  ...
                  <div className="noise-frequency-metrics">
                    <div className="noise-frequency-metric">
                      <span className="noise-frequency-metric-icon">∿</span>
                      <div>
                    ...
                    <div className="noise-frequency-metric">
                      ...
                      <div>
                        ...
                        <strong>
                          {result.noise_frequency_analysis?.noise_standard_deviation != null
                            ? formatSafeNumber(
                              result.noise_frequency_analysis.noise_standard_deviation,
                              2
                            )
                            : "—"}
                        </strong>
                    ...
                    <div className="noise-frequency-metric">
                      ...
                      <div>
                        ...
                        <strong>
                          {result.noise_frequency_analysis?.sharpness_level || "—"}
                        </strong>
                      </div>
                    </div>
                    ...
                    <div className="noise-frequency-metric">
                      ...
                      <div>
                        ...
                        <strong>
                          {result.noise_frequency_analysis?.high_frequency_energy_ratio != null
                            ? `${formatSafeNumber(
                              result.noise_frequency_analysis.high_frequency_energy_ratio,
                              2
                            )} (${formatSafeNumber(
                              result.noise_frequency_analysis.high_frequency_energy_ratio * 100,
                              2
                            )}%)`
                            : "—"}
                        </strong>
                    ...
                    <div className="noise-frequency-metric">
                      <span className="noise-frequency-metric-icon">◌</span>
                      <div>
                        <span>FREQUENCY CHARACTERISTIC</span>
                        <strong>
                          {result.noise_frequency_analysis?.frequency_characteristic || "—"}
                        </strong>
                      </div>
                    </div>
                  </div>

                  <div className="noise-frequency-visual-grid">
                    <div className="noise-frequency-visual-card">
                      <div className="noise-frequency-visual-title">
                        Original Image
                      </div>
                      <div className="noise-frequency-image-frame">
                        {previewUrl ? (
                          <img
                            src={previewUrl}
                            alt="Original submitted evidence"
                            className="noise-frequency-image"
                          />
                        ) : (
                          <div className="noise-frequency-image-empty">
                    ...
                    <div className="noise-frequency-visual-card">
                      <div className="noise-frequency-visual-title">
                        Noise Map <span>(High-Frequency Details)</span>
                      </div>
                      <div className="noise-frequency-image-frame">
                        {result.noise_frequency_analysis?.noise_map_base64 ? (
                          <img
                    ...
                    <div className="noise-frequency-visual-card">
                      ...
                      <div className="noise-frequency-image-frame">
                        {result.noise_frequency_analysis?.fft_spectrum_base64 ? (
                          <img
                  ...
                  <div className="noise-frequency-visual-grid">
                    <div className="noise-frequency-visual-card">
                      <div className="noise-frequency-visual-title">
                        Low-Frequency Component <span>(Smooth Structures)</span>
                      </div>
                      <div className="noise-frequency-image-frame">
                        {result.noise_frequency_analysis?.low_frequency_base64 ? (
                          <img
                    ...
                    <div className="noise-frequency-visual-card">
                      <div className="noise-frequency-visual-title">
                        High-Frequency Component <span>(Edges & Fine Details)</span>
                      </div>
                      <div className="noise-frequency-image-frame">
                        {result.noise_frequency_analysis?.high_frequency_base64 ? (
                          <img
                  ...
                  <div className="noise-frequency-lower-grid">
                    <div className="noise-frequency-chart-card">
                      <div className="noise-frequency-visual-title">
                        Frequency Distribution
                      </div>

                      <div className="noise-frequency-chart">
                        {(() => {
                          const points = result.noise_frequency_analysis?.frequency_distribution ?? [];
                          const maxEnergy = Math.max(
                            ...points.map((point) => Number(point.energy ?? 0)),
                            0.000001
                          );
                          ...
                          const path = points
                            .map((point, index) => {
                              ...
                              const y =
                                padding +
                                chartHeight -
                                (Number(point.energy ?? 0) / maxEnergy) * chartHeight;
                          ...
                          return (
                            <svg
                              ...
                              className="noise-frequency-svg"
                              role="img"
                              aria-label="Frequency energy distribution"
                            >
                              {[0, 1, 2, 3, 4].map((tick) => {
                                const y =
                                  padding +
                                ...
                                return (
                                  <line
                                    ...
                                    y1={y}
                                    y2={y}
                                    className="noise-frequency-gridline"
                                  />
                                );
                              })}

                              <path
                                d={path || `M ${padding} ${height - padding}`}
                                className="noise-frequency-line"
                                fill="none"
                              />
                              ...
                              <text
                                x={padding}
                                y={height - 7}
                                className="noise-frequency-axis-label"
                              >
                                Low frequency
                              </text>
                    ...
                    <div className="noise-frequency-visual-card">
                      ...
                      <div className="noise-frequency-image-frame">
                        {result.noise_frequency_analysis?.noise_heatmap_base64 ? (
                          <img
                    ...
                    <div className="noise-frequency-key-metrics">
                      <div className="noise-frequency-visual-title">
                        Key Metrics
                      </div>
                      ...
                      <MetadataRow
                        label="Image Width"
                        value={
                          result.noise_frequency_analysis?.image_width != null
                            ? `${result.noise_frequency_analysis.image_width} px`
                            : imageWidth
                              ? `${imageWidth} px`
                              : "—"
                        }
                      ...
                      <MetadataRow
                        label="Image Height"
                        value={
                          result.noise_frequency_analysis?.image_height != null
                            ? `${result.noise_frequency_analysis.image_height} px`
                            : imageHeight
                              ? `${imageHeight} px`
                              : "—"
                        }
                      ...
                      <MetadataRow
                        ...
                        value={
                          result.noise_frequency_analysis?.noise_variance != null
                            ? formatSafeNumber(
                              result.noise_frequency_analysis.noise_variance,
                              2
                            )
                            : "—"
                        }
                      ...
                      <MetadataRow
                        label="Sharpness Variance"
                        value={
                          result.noise_frequency_analysis?.sharpness_variance != null
                            ? formatSafeNumber(
                              result.noise_frequency_analysis.sharpness_variance,
                              2
                            )
                            : "—"
                        }
                      ...
                      <MetadataRow
                        ...
                        value={
                          result.noise_frequency_analysis?.frequency_energy != null
                            ? formatSafeNumber(
                              result.noise_frequency_analysis.frequency_energy,
                              2
                            )
                            : "—"
                        }
                  ...
                  <div className="noise-frequency-summary-grid">
                    <div className="noise-frequency-summary-card">
                      <div className="noise-frequency-summary-icon">
                        ✦
                      </div>
                      <div>
                        <h3>Visual Analysis Summary</h3>
                        <p>
                          The analysis reports {result.noise_frequency_analysis?.noise_level?.toLowerCase() || "unknown"} noise levels with a {result.noise_frequency_analysis?.frequency_characteristic?.toLowerCase() || "reported"}.
                          The visual maps and FFT spectrum are generated directly from the submitted image.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="noise-frequency-summary-card">
                      ...
                      <div>
                        <h3>Forensic Note</h3>
                        <p>
                          {result.noise_frequency_analysis?.forensic_note ||
                            "Noise, sharpness, and frequency characteristics are supporting forensic indicators only."}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <section className="dashboard-card forensic-workbench-card">
                  ...
                  <div className="planned-evidence-grid">
                    <div className="forensic-module-card">
                      <div className="module-status module-active">
                        ACTIVE
                      </div>
                      ...
                      <p>
                        Detect and isolate facial
                        regions within submitted
                        evidence.
                      </p>
                    </div>
                    ...
                    <div className="forensic-module-card">
                      ...
                      <p>
                        Evaluate detected facial imagery
                        using the EfficientNet classification
                        model.
                      </p>
                    </div>
                    ...
                    <div className="forensic-module-card">
                      ...
                      <p>
                        Inspect available image metadata
                        and embedded properties returned by
                        the forensic engine.
                      </p>
                    </div>
  ...
  ACTIVE
                      ...
                      <p>
                        Examine compression-related
                        indicators and image integrity
                        signals.
                      </p>
                    </div>
  ...
  ACTIVE
                      ...
                      <p>
                        Analyze image noise patterns as
                        an additional forensic signal.
                      </p>
                    </div>
  ...
  ACTIVE
                ...
                <div className="result-disclaimer">
                  ...
                  <p>
                    Classification output and metadata
                    observations are analytical findings,
                    not standalone proof of authenticity
                    or manipulation. Metadata can be
                    altered or removed independently of the
                    underlying image content. VERITAS does
                    not present unavailable forensic modules
...
function HistoryPage({
    ...
    <div className="page-section">
      ...
      {history.length === 0 ? (
        <div className="empty-state">
          ...
          <p>
            Completed media analyses will appear here
            after you run an investigation.
          </p>
        </div>
      ) : (
  ...
  <div>
    ...
    <p className="panel-description">
      ...
      {history.length === 1 ? "" : "s"} recorded in this workspace session.
    </p>
  </div>
...
function ReportsPage({
  ...
  const fakeCount = history.filter(
    (item) => item.verdict === "FAKE"
  ).length;

  const realCount = history.filter(
    (item) => item.verdict === "REAL"
  ).length;
  ...
  async function openReport() {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Report endpoint returned ${response.status}.`
        );
      }
      ...
      console.error(
        "Forensic report download error:",
        error
      );
      window.alert(
    ...
    <div className="page-section">
      ...
      <div className="report-builder-card">
        ...
        <div className="report-builder-copy">
          ...
          <p>
            VERITAS generates a structured forensic report after
            a completed media analysis. The report is linked to
            the latest investigation and contains the evidence
            summary produced by the backend forensic engine.
          </p>
          ...
          {reportAvailable ? (
            <>
              ...
              <span className="history-summary-badge">
                REPORT READY
              </span>
            </>
          ) : (
  ...
  return (
    <div className="page-section">
      ...
      <div className="system-note">
        ...
        <p>
          A loaded model does not automatically mean that
          forensic performance is validated. Proper evaluation,
          including cross-dataset testing, remains part of the
          VERITAS validation workflow.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="metric-card">
      <div className="metric-top">
        ...
        <span
          className={`metric-icon metric-icon-${status}`}
        >
          {icon}
        </span>
      </div>
